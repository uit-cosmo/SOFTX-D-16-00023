...
SUBROUTINE Initial_Temp (Temp)
  ! Here you change the initial temperature. 
  ! You can decide between uniform temperature then comment the lines below close(344) out or loading a 
  ! .dat file with initial temperature generated by one of the Python scripts.
  IMPLICIT NONE
  INCLUDE 'ebm.inc'
